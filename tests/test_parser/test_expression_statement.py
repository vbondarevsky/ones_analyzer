...
class TestParserExpressionStatement(TestCaseParser):
    def test_two_expression(self):
        ...
        self.assertNode(self.syntax_tree.statements[0].expression.left, SyntaxKind.IdentifierName)
        ...
        self.assertNode(self.syntax_tree.statements[1].expression.left, SyntaxKind.IdentifierName)
    ...
    def test_member_access_expression_one_dot(self):
        self.parse_source("A.Б")
        self.assertNode(self.syntax_tree.statements, [SyntaxKind.ExpressionStatement])
        self.assertNode(self.syntax_tree.statements[0].expression, SyntaxKind.MemberAccessExpression)
        self.assertNode(self.syntax_tree.statements[0].expression.expression, SyntaxKind.IdentifierName)
        self.assertNode(self.syntax_tree.statements[0].expression.operator_token, SyntaxKind.DotToken)
        self.assertNode(self.syntax_tree.statements[0].expression.name, SyntaxKind.IdentifierName)
        self.assertNode(self.syntax_tree.statements[0].semicolon_token, SyntaxKind.Empty)

    def test_member_access_expression_two_dot(self):
        self.parse_source("A.Б.В")
        self.assertNode(self.syntax_tree.statements, [SyntaxKind.ExpressionStatement])
        self.assertNode(self.syntax_tree.statements[0].expression, SyntaxKind.MemberAccessExpression)
        self.assertNode(self.syntax_tree.statements[0].expression.expression, SyntaxKind.MemberAccessExpression)
        self.assertNode(self.syntax_tree.statements[0].expression.expression.operator_token, SyntaxKind.DotToken)
        self.assertNode(self.syntax_tree.statements[0].expression.expression.name, SyntaxKind.IdentifierName)
        self.assertNode(self.syntax_tree.statements[0].expression.operator_token, SyntaxKind.DotToken)
        self.assertNode(self.syntax_tree.statements[0].expression.name, SyntaxKind.IdentifierName)
        self.assertNode(self.syntax_tree.statements[0].semicolon_token, SyntaxKind.Empty)
